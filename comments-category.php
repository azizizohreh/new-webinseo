...
//    return;
//}
global $commenter,$html_req,$html5;
$fields = array(
    'author' => sprintf(
...
$args = array(
    ...
    'submit_button'        => '<button type="submit" class="btn btn-gradient comment-btn">ثبت حرف دل من</button>',
    ...
    <div id="comments" class="post-comments-area">
        <div class="comments-area">
            <div class="post-new-comment">
                <?php comment_form($args,$post); ?>
            </div>
            <?php if ($comments) : ?>

                <ul class="commentlist" itemscope itemtype="http://schema.org/UserComments">
                    <?php
                    wp_list_comments(array('callback' => 'webin_comment','reverse_top_level' => false),$comments);
                    ?>
                </ul>
