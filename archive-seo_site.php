...
$title = $seo_site_info['seo_site_title'];
?>
<main class="web-design">
            ...
            <div class="web-design-head d-flex flex-wrap flex-row align-items-center ">
                <div class="col-lg-6 col-md-12 col-12 order-2 order-lg-1">
                    ...
                    <div class="web-design-content content">
                        <?php
                        $html = get_option('seo_site_description');
                    ...
                    <div class="web-design-thumb">
                        ...
                        if ($seo_site_video) {
                            ...
                            <div class="video-wrapper">
                                ...
                                <script async>
                                    var player = new Playerjs({id:"player", file:"<?php echo $seo_site_video ?>", poster:"<?php echo $seo_site_poster ?>"});
                                </script>
                            </div>
                            <script type="application/ld+json">
                                {
                                ...
                                "description": "<?php echo $meta; ?>",
                                "thumbnailUrl": "<?php echo $seo_site_poster ?>",
                                "uploadDate": "<?php echo get_post_time('d F Y') ?>",
                                "duration": "PT2M",
                                "contentUrl": "<?php echo $seo_site_video ?>",
                        ...
                        <img <?php echo getimagesize($seo_site_img)[3]; ?> src="<?php echo $seo_site_img ?>"
                                                                           alt="<?php echo $seo_site_img_alt ?>">
                        <?php } ?>
                    </div>
                </div>
            </div>
    ...
    if (have_posts()) { ?>
        <div class="web-design-list">
            <div class="container">
                <h4 class="portfolio-title">ما چه نوع سایت هایی سئو می کنیم؟</h4>
